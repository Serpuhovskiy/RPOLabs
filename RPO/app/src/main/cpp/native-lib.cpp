...
JNICALL Java_com_example_fclient_MainActivity_stringFromJNI(JNIEnv *env, jobject thisObject) {
...
JNICALL Java_com_example_fclient_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
JNICALL Java_com_example_fclient_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray
JNICALL Java_com_example_fclient_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray
JNICALL Java_com_example_fclient_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
//    jmethodID id = env->GetMethodID(cls, "enterPin", "(ILjava/lang/String;)Ljava/lang/String;");
    ...
    std::thread t([thiz, trd] {
        ...
        buf[12] = 0x00;
        jstring amount = (jstring) env->NewStringUTF(buf);
        int ptc = 3;
        while (ptc > 0) {
